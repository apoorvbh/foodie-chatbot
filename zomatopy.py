...
class Zomato:
    ...
    def get_categories(self):
        ...
        r = (requests.get(self.base_url + "categories", headers=headers).content).decode("utf-8")
    ...
    def get_city_ID(self, city_name):
        ...
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "cities?q=" + city_name, headers=headers).content).decode("utf-8")
        a = ast.literal_eval(r)
    ...
    def get_city_name(self, city_ID):
        ...
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "cities?city_ids=" + str(city_ID), headers=headers).content).decode("utf-8")
        a = ast.literal_eval(r)
    ...
    def get_collections(self, city_ID, limit=None):
        ...
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        if limit == None:
            r = (requests.get(self.base_url + "collections?city_id=" + str(city_ID), headers=headers).content).decode("utf-8")
        else:
            if str(limit).isalpha() == True:
                raise ValueError('LimitNotInteger')
            else:
                r = (requests.get(self.base_url + "collections?city_id=" + str(city_ID) + "&count=" + str(limit), headers=headers).content).decode("utf-8")
        a = ast.literal_eval(r)
    ...
    def get_establishment_types(self, city_ID):
        ...
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "establishments?city_id=" + str(city_ID), headers=headers).content).decode("utf-8")
        a = ast.literal_eval(r)
    ...
    def get_nearby_restaurants(self, latitude, longitude):
        ...
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "geocode?lat=" + str(latitude) + "&lon=" + str(longitude), headers=headers).content).decode("utf-8")
        a = ast.literal_eval(r)
    ...
    def get_restaurant(self, restaurant_ID):
        ...
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "restaurant?res_id=" + str(restaurant_ID), headers=headers).content).decode("utf-8")
        a = ast.literal_eval(r)
    ...
    def restaurant_search(self, query="", latitude="", longitude="", cuisines="", limit=5, sort='rating', order='desc'):
        """
        ...
        if str(limit).isalpha() == True:
            raise ValueError('LimitNotInteger')
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "search?q=" + str(query) + "&count=" + str(limit) + "&lat=" + str(latitude) +\
        "&lon=" + str(longitude) + "&cuisines=" + str(cuisines) + "&sort=" + str(sort) + "&order=" + str(order), 
    ...
    def get_location(self, query="", limit=5):
        ...
        if str(limit).isalpha() == True:
            raise ValueError('LimitNotInteger')
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "locations?query=" + str(query) + "&count=" + str(limit), headers=headers).content).decode("utf-8")
        return r
    ...
    def restaurant_search_by_keyword(self, query="", cuisines="", limit=5):
        ...
        if str(limit).isalpha() == True:
            raise ValueError('LimitNotInteger')
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
        r = (requests.get(self.base_url + "search?q=" + str(query) + "&count=" + str(limit) + "&cuisines=" + str(cuisines), headers=headers).content).decode("utf-8")
        return r
